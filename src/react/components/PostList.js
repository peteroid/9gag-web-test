    ...
    return (
      <div className="post-link row">
        <a target="_blank" href={'//www.instagram.com/p/' + this.props.code} className="post-img-wrapper col-sm-7 col-xs-12">
          ...
          <div style={{backgroundImage: 'url(' + (this.state.isPlaying? '' : this.getRawUrl(this.props.is_video? this.props.thumbnail_src : this.props.display_src)) + ')'}} className="post-img v-container">
