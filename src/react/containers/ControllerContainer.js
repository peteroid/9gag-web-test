  ...
  render() {
    return (
      <div className="container text-center control-panel">
        ...
        <div className="btn-group col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2 col-xs-12" role="group">
          <button type="button" className={"col-xs-4 btn btn-" + (this.props.sortKey == 'date' ? 'success' : 'default')}
            onClick={this.props.setSortKey.bind(null, 'date')}><i className="fa fa-clock-o"></i> Date</button>
          <button type="button" className={"col-xs-4 btn btn-" + (this.props.sortKey == 'likes_count' ? 'success' : 'default')}
            onClick={this.props.setSortKey.bind(null, 'likes_count')}><i className="fa fa-heart"></i> Likes</button>
          <button type="button" className={"col-xs-4 btn btn-" + (this.props.sortKey == 'comments_count' ? 'success' : 'default')}
